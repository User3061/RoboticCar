...
Below you can find the source code used for the control of the car using the arduino:
\begin{lstlisting}
//Line Sensors
...
Below you can find the code for the camera stream ran on the server side:
\begin{lstlisting}
#include <sys/types.h>
  #include <sys/socket.h>
  #include <netinet/in.h>
